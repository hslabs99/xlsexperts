...
export async function generateMetadata(): Promise<Metadata> {
  return marketPageMetadata({
    ...
    description:
      'Business systems built around the way you work — dashboards, resource planning, financial modelling, manufacturing costing, property development, asset maintenance operations, quoting, field apps, portals and workflow automation.',
  })
}
